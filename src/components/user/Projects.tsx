...
export default function Projects({ userId, github }: Props) {
  ...
  return (
    <section className='px-12 py-32 relative w-full flex flex-col items-center max-w-screen-xl bg-point2'>
      ...
      <p className='text-center mt-4 mb-12 text-lg'>
        ...
        <span className='font-bold bg-white px-1 ml-1'>side</span> is a project
        that I personally did for study purposes.
      </p>
